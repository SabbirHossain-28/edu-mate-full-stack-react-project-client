        ...
        <div className="min-h-screen">
          {enrolledClassData.length === 0 ? (
            <p className="text-3xl font-semibold font-raleWay text-center text-base-orange">
              Currently there is no enrolled class information.You are not enroll any class yet.Go to the all class page and enroll your class which you want to learn from our platform and build-up your skill for present tech world.All the best..{" "}
            </p>
          ) : (
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          <Link
                            to={`/dashboard/enrollClassDetails/${data?._id}`}
                          >
