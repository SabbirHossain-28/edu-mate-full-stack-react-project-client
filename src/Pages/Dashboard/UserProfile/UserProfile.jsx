    ...
    <div className="bg-slate-200 dark:bg-gray-900 px-4 py-8 lg:px-0 lg:py-0 min-h-screen flex items-center justify-center">
      <div className="flex w-[550px] flex-col items-center justify-center space-y-4 rounded-xl bg-base-green p-8 font-sans shadow-lg dark:bg-base-green">
        ...
        <div className="space-y-1 text-center">
          <h1 className="text-2xl text-gray-300 dark:text-white/90">
            {userData?.name}
          </h1>
        ...
        <button className="w-[80%] rounded-full py-2 font-medium text-gray-400 shadow-[0px_0px_10px_#E2DADA] duration-500 hover:scale-95  hover:bg-base-orange hover:text-white hover:shadow-xl dark:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.8)]">
          View Profile
        </button>
      </div>
    </div>
